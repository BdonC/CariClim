...
class country_analysis(object):
    ...
    def load_data(self,quiet=False,filename_filter='',load_mask=True,load_raw=True,load_area_averages=True,load_region_polygons=True,load_merged_regions=False):
        '''
    ...
    def ensemble_mean(self,silent=False):
        '''
        identify ensembles and compute ensemble mean for each ensemble
        '''
        # why do I need this????? see hist_merge
